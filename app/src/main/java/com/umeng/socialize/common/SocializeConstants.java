...
public class SocializeConstants {
    ...
    public static final String SDK_VERSION = "6.4.6";
    public static final String COMMON_TAG = "com.umeng.socialize";
    public static final String PROTOCOL_VERSON = "2.0";
    public static final String DOWN_URL_QQ = "http://log.umsns.com/link/qq/download/";
    public static final String DOWN_URL_WX = "http://log.umsns.com/link/weixin/download/";
